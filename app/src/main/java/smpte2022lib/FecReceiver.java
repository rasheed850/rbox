...
public class FecReceiver
{
	...
	protected Queue<RtpPacket> outMedias;  //. TODO
	...
	public FecReceiver(BufferedOutputStream pOutPayload, Queue<RtpPacket> pOutMedias)
	{
			...
			case packets: // based on buffer size
				while (medias.size() > value)
				{
					...
					if (media != null)
					{
						...
						if (outMedias  != null) outMedias.offer(media);
					}
					else
					{
